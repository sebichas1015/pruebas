...
`import_individual` &rightarrow; `class_entities` &rightarrow; `pivot` (opcional) &rightarrow; `clean_entities` &rightarrow; `new_vars` &rightarrow; `match` &rightarrow; `gen_ids` &rightarrow; `merge_values` &rightarrow; `append` &rightarrow; `homl_validate`

...
def getargs():
    ...
    parser.add_argument("--input_df", default=None, required=True)
    parser.add_argument("--input_df_nc", default=None, required=True)
    parser.add_argument("--input_df_cannon", default=None, required=True)
    parser.add_argument("--output_df", default=None, required=True)
...
path_canon = glob.glob(args.input_df_cannon)
